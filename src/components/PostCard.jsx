...
const PostCard = ({ item }) => {
  ...
  return (
    <div onClick={() => dispatch(selected(item))} className='border p-5 rounded-2xl shadow-2xl border-gray-100 w-[250px] cursor-pointer hover:bg-amber-50 transition-all hover:shadow'>
      <div>
